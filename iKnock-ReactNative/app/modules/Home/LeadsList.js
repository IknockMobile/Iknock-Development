...
class LeadsList extends Component {
  constructor(props) {
    ...
    this.onChangeTextDelayed = debounce(this.flatListHandlerFetchData, 500);
  }
  state = {
    selectedTimePeriod: '',
    selectedUser: [],
  ...
  OnItemPressed = (item, index) => {
    ...
    this.props.navigation.navigate('summary', {
      ...
      index,
      type: 'leadList',
      currLatLong: {latitude: this.state.currLat, longitude: this.state.currLong},
    });
  };
  renderSeperator = () => {
  ...
  onChangeText = (text) => {
    ...
    this.setState({isSearching: text}, this.onChangeTextDelayed);
  };
  onClearText = () => {
    this.setState(
      {
