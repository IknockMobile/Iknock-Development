...
class History
{
    ...
    private function leadAssignee()
    {
        if($this->old_node['assignee_id'] != $this->new_node['target_id'] && !empty($this->old_node['assignee_id'])) {
            ...
            $lead_assignee = User::getById($this->new_node['target_id']);
    ...
    private function leadStatus()
    {
        if($this->old_node['status_id'] != $this->new_node['status_id']) {
            ...
            $params['lead_history_id'] = $obj_lead_history;

            $params['user_id'] = $this->new_node['user_id'];
            $params['status_id'] = $this->new_node['status_id'];
            $params['lead_id'] = $this->new_node['id'];
