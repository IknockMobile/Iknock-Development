...
Route::get('lead/map/list', 'LeadController@indexAPI');


Route::get('new/lead/list', 'LeadController@indexNew');
Route::get('new/lead/map/list', 'LeadController@newIndexAPI');
...
Route::get('v2/lead/map/list', 'LeadController@v2IndexMap');
Route::get('v2/lead/list', 'LeadController@v2Index');
