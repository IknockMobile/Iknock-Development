...
!(function (a) {
                    ...
                    .done(
                        a.proxy(function (a) {
                            ...
                            return b === !1
                                ...
                                : (b && "object" == typeof b && b.hasOwnProperty("newValue") && (d = b.newValue), this.error(!1), (this.value = d), this.$div.triggerHandler("save", { newValue: d, submitValue: e, response: a }), void 0);
                        }, this)
                    )
                    .fail(
                        a.proxy(function (a) {
                ...
                if (((this.options.name = this.options.name || this.$element.attr("id")), (this.options.scope = this.$element[0]), (this.input = a.fn.editableutils.createInput(this.options)), this.input)) {
                    switch (
                        (void 0 === this.options.value || null === this.options.value
                            ...
                            : ((this.options.value = a.fn.editableutils.tryParseJson(this.options.value, !0)), (this.value = "string" == typeof this.options.value ? this.input.str2value(this.options.value) : this.options.value)),
            ...
            option: function (b, c) {
                return b && "object" == typeof b
                    ? (a.each(
                      ...
                      void 0)
                    : ((this.options[b] = c),
                      "disabled" === b ? (c ? this.disable() : this.enable()) : ("value" === b && this.setValue(c), this.container && this.container.option(b, c), this.input.option && this.input.option(b, c), void 0));
            },
            handleEmpty: function (b) {
                this.options.display !== !1 &&
                    ((this.isEmpty = void 0 !== b ? b : "function" == typeof this.input.isEmpty ? this.input.isEmpty(this.$element) : "" === a.trim(this.$element.html())),
                        ...
                        return (
                            a.isEmptyObject(j)
                                ? ((g = this.editable("getValue")),
                                  ...
                                  a
                                      .ajax(a.extend({ url: h.url, data: g, type: "POST" }, h.ajaxOptions))
                                      .success(function (a) {
    ...
    (function (a) {
        var b = function (b, c) {
            return (
                (this.$element = a(b)), this.$element.is("input") ? ((this.options = a.extend({}, a.fn.combodate.defaults, c, this.$element.data())), this.init(), void 0) : (a.error("Combodate should be applied to INPUT element"), void 0)
            );
        };
        (b.prototype = {
            constructor: b,
            ...
            getValue: function (b) {
                ...
                return (
                    ...
                    f
                        ? ""
                        : (this.$ampm && (d.hour = 12 === d.hour ? ("am" === this.$ampm.val() ? 0 : 12) : "am" === this.$ampm.val() ? d.hour : d.hour + 12),
    ...
    (function (a) {
        ...
        e.prototype = {
            ...
            _buildEvents: function () {
                this.isInput
                    ? (this._events = [[this.element, { focus: a.proxy(this.show, this), keyup: a.proxy(this.update, this), keydown: a.proxy(this.keydown, this) }]])
            ...
            update: function () {
                if (this._allow_update) {
                    ...
                    arguments && arguments.length && ("string" == typeof arguments[0] || arguments[0] instanceof Date)
                        ? ((a = arguments[0]), (b = !0))
                        : ((a = this.isInput ? this.element.val() : this.element.data("date") || this.element.find("input").val()), delete this.element.data().date),
            ...
            fill: function () {
                ...
                for (var p, q = []; m.valueOf() < o; ) {
                    ...
                    void 0 === v ? (v = {}) : "boolean" == typeof v ? (v = { enabled: v }) : "string" == typeof v && (v = { classes: v }),
                    ...
                    switch (this.viewMode) {
                        case 0:
                            this.o.startDate !== -1 / 0 && b <= this.o.startDate.getUTCFullYear() && c <= this.o.startDate.getUTCMonth()
                                ...
                                1 / 0 !== this.o.endDate && b >= this.o.endDate.getUTCFullYear() && c >= this.o.endDate.getUTCMonth()
                                    ? this.picker.find(".next").css({ visibility: "hidden" })
                                    : this.picker.find(".next").css({ visibility: "visible" });
                            break;
                        case 1:
                        case 2:
                            this.o.startDate !== -1 / 0 && b <= this.o.startDate.getUTCFullYear() ? this.picker.find(".prev").css({ visibility: "hidden" }) : this.picker.find(".prev").css({ visibility: "visible" }),
                                1 / 0 !== this.o.endDate && b >= this.o.endDate.getUTCFullYear() ? this.picker.find(".next").css({ visibility: "hidden" }) : this.picker.find(".next").css({ visibility: "visible" });
                    }
                }
            },
            click: function (c) {
                    ...
                    case 39:
                        ...
                        (b = 37 == a.keyCode ? -1 : 1),
                            a.ctrlKey
                                ...
                                : ((c = new Date(this.date)), c.setUTCDate(this.date.getUTCDate() + b), (d = new Date(this.viewDate)), d.setUTCDate(this.viewDate.getUTCDate() + b)),
                    ...
                    case 40:
                        ...
                        (b = 38 == a.keyCode ? -1 : 1),
                            a.ctrlKey
                                ...
                                : a.shiftKey
                                ? ((c = this.moveMonth(this.date, b)), (d = this.moveMonth(this.viewDate, b)))
                                : ((c = new Date(this.date)), c.setUTCDate(this.date.getUTCDate() + 7 * b), (d = new Date(this.viewDate)), d.setUTCDate(this.viewDate.getUTCDate() + 7 * b)),
                            this.dateWithinRange(c) && ((this.date = c), (this.viewDate = d), this.setValue(), this.update(), a.preventDefault(), (e = !0));
                        break;
                    case 13:
                        this.hide(), a.preventDefault();
