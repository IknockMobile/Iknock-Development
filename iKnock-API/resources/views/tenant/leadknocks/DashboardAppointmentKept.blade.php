...
<div class="right_col" role="main">
    <div class="container body">
        <div class="col-md-3">
            <div class="cust-head"><i class="fas fa-clipboard-list"></i>  Appointments KEPT Conversion Rate </div>
        </div>
        <div class="col-md-7">
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr> <?php $x = $x + 1; ?>
                            ...
                            <td>
                                <a href="{{ URL::to('tenant/history/'.$data->id.'/edit') }}?type=appointments_kept" class="btn btn-primary btn-sm"><i class="fas fa-pen"></i></a>
...
<script>
    ...
    var url = '{{ URL::to('tenant/dashboard/appointments_kept/list') }}';
    ...
    $('.export-btn').click(function (e) {
        ...
        var url = '{{ URL::to('tenant/dashboard/appointments_kept/list/export') }}';
