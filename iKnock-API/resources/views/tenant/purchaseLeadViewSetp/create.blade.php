...
<div class="right_col" role="main">
	<div class="container body">
		<div class="col-md-12">
			<div class="cust-head"><i class="fas fa-list"></i> Create Purchase Lead View Setup</div>
		</div>
		<div class="col-md-12 mt-5">
			<div class="panel panel-default">
				<div class="panel-heading">
					<div class="row">
						<div class="col-md-6">
							<h5>Create Purchase Lead View Setup</h5>
						</div>
				...
				<div class="panel-body">
					  ...
					  @endif
					<form action="{{ route('tenant.purchase-leadview.store') }}" method="post">
						@csrf
						<div class="row">
							<div class="col-md-6">
						...
						<div class="hidebox">
							...
							<div class="row m-0 customModelbox">
								<div class="col-md-8 mb-0 p-0">
									...
									<div class="subcustombox custom-list-sort">
										<div class="col-md-12">
											<div class="col-md-10 m-0 p-0">
