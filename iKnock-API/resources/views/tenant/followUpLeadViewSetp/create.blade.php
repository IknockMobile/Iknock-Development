...
<div class="right_col" role="main">
	<div class="container body">
		<div class="col-md-12">
			<div class="cust-head"><i class="fas fa-list"></i> Create Follow Up Lead View Setup</div>
		</div>
		<div class="col-md-12 mt-5">
			<div class="panel panel-default">
				<div class="panel-heading">
					<div class="row">
						<div class="col-md-6">
							<h5>Create Follow Up Lead View Setup</h5>
						</div>
				...
				<div class="panel-body">
					  ...
					  @endif
					<form action="{{ route('tenant.follow-leadview.store') }}" method="post">
						@csrf
						<div class="row">
							<div class="col-md-6">
