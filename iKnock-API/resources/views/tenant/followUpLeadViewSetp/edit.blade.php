...
<div class="right_col" role="main">
    <div class="container body">
        <div class="col-md-12">
            <div class="cust-head"><i class="fas fa-list"></i> Edit Follow Up Lead View Setup</div>
        </div>
        <div class="col-md-12 mt-5">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <div class="row">
                        <div class="col-md-6">
                            <h5>Edit Follow Up Lead View Setp</h5>
                        </div>
                        <div class="col-md-6 text-right">
                            <a href="{{ route('tenant.follow-leadview.index') }}" class="btn btn-primary btn-sm"><i class="fas fa-arrow-left"></i></a>
                        </div>
                    </div>
                </div>
                <div class="panel-body">
                    <form action="{{ route('tenant.follow-leadview.update',$follow_leadview->id) }}" method="post">
                        @csrf
                        @method('put')
                        <div class="row">
                            <div class="col-md-6">
