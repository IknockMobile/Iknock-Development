...
<td class="followup_fields " data-tdhref="{{asset('tenant/followup-lead/'.$followingLead['id'].'/edit')}}" >
    ...
    @elseif($followUpLeadViewSetp->title_slug == 'is_purchase')
        <button class="btn btn-primary isPurchase btn-sm" data-id="{{ $followingLead['id'] }}"><i class="fas fa-shopping-cart"></i> Purchase</button>
    ...
    @elseif($followUpLeadViewSetp->title_slug == 'investor_notes')
        <?php 
        if($followingLead['investor_notes'] != ''){
            echo substr($followingLead['investor_notes'],0,30);
        }
        ?>
    ...
    @elseif($followUpLeadViewSetp->title_slug == 'action')
    <a href="{{asset('tenant/followup-lead/'.$followingLead['id'].'/edit')}}">
        Edit
    </a>   
    ...
    @else
        @if($followUpLeadViewSetp->input_type == 1)
            <a href="#" data-name="{{ $followUpLeadViewSetp->view_type == 1 ?  getCustomFiled($followUpLeadViewSetp->title_slug,$followingLead['id'])->id :$followUpLeadViewSetp->title_slug }}" class="{{ $followUpLeadViewSetp->view_type == 1 ? 'detailCustomUpdate':'detailupdate' }}  editable editable-click" data-type="text" data-value="{{  $followingLead[$followUpLeadViewSetp->title_slug] }}" data-pk="{{ $followingLead['id'] }}" data-title="title" data-original-title="Enter {{ $followUpLeadViewSetp->title }}:" title="">{{ $followingLead[$followUpLeadViewSetp->title_slug] }}</a>
        @elseif($followUpLeadViewSetp->input_type == 2)
              <a href="#" data-name="{{ $followUpLeadViewSetp->view_type == 1 ?  getCustomFiled($followUpLeadViewSetp->title_slug,$followingLead['id'])->id :$followUpLeadViewSetp->title_slug }}" class="{{ $followUpLeadViewSetp->view_type == 1 ? 'detailCustomUpdate':'detailupdate' }}  editable editable-click" data-type="date" data-pk="{{ $followingLead['id'] }}" data-value="{{  $followingLead[$followUpLeadViewSetp->title_slug] }}" data-title="title" data-original-title="Enter {{ $followUpLeadViewSetp->title }}:" title="">{{ $followingLead[$followUpLeadViewSetp->title_slug] }}</a>
        @elseif($followUpLeadViewSetp->input_type == 3)
             <a href="#" data-name="{{ $followUpLeadViewSetp->view_type == 1 ?  getCustomFiled($followUpLeadViewSetp->title_slug,$followingLead['id'])->id :$followUpLeadViewSetp->title_slug }}" class="{{ $followUpLeadViewSetp->view_type == 1 ? 'detailCustomUpdate':'detailupdate' }}  editable editable-click" data-type="number" data-pk="{{ $followingLead['id'] }}" data-value="{{  $followingLead[$followUpLeadViewSetp->title_slug] }}"  data-title="title" data-original-title="Enter {{ $followUpLeadViewSetp->title }}:" title="">{{ $followingLead[$followUpLeadViewSetp->title_slug] }}</a>
        @elseif($followUpLeadViewSetp->input_type == 4)
           <a href="#" data-name="{{ $followUpLeadViewSetp->view_type == 1 ?  getCustomFiled($followUpLeadViewSetp->title_slug,$followingLead['id'])->id :$followUpLeadViewSetp->title_slug }}" class="{{ $followUpLeadViewSetp->view_type == 1 ? 'detailCustomUpdate':'detailupdate' }}  editable editable-click" data-type="number" data-pk="{{ $followingLead['id'] }}" data-title="title" data-value="{{  $followingLead[$followUpLeadViewSetp->title_slug] }}"  data-original-title="Enter {{ $followUpLeadViewSetp->title }}:" title="">{{ $followingLead[$followUpLeadViewSetp->title_slug] }}</a>
        @elseif($followUpLeadViewSetp->input_type == 5)
            <a href="#" data-name="{{ $followUpLeadViewSetp->view_type == 1 ?  getCustomFiled($followUpLeadViewSetp->title_slug,$followingLead['id'])->id :$followUpLeadViewSetp->title_slug }}" class="{{ $followUpLeadViewSetp->view_type == 1 ? 'detailCustomUpdate':'detailupdate' }}  editable editable-click" data-type="select" data-source="{{ $followUpLeadViewSetp->pickListArray }}" data-value="{{ $followingLead[$followUpLeadViewSetp->title_slug] }}"  data-pk="{{ $followingLead['id'] }}" data-title="title" data-original-title="Enter {{ $followUpLeadViewSetp->title }}:" title="">{{ $followingLead[$followUpLeadViewSetp->title_slug] }}</a>
        @endif
    @endif
</td>
@empty
