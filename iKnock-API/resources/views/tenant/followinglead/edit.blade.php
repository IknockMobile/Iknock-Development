    ...
    <div class="right_col" role="main">
        <div class="row" id="content-heading">
            ...
            <div class="col-md-9">
                <h1 class="cust-head">Edit Follow Up Lead</h1>
            </div>
            <div class="col-md-3">
        ...
        <div class="row" id="pg-content">
            ...
            <div class="col-md-5" style="padding-left:0px;">
                <div class="jumbotron">
                    ...
                    <form action="{{ route('tenant.followup-lead.update',$followup_lead->id) }}" class="formEditFollwing" method="post">
                        @csrf	
...
//       });
    ...
    $('.submit_appt_url').click(function (e) {
            ...
            type: 'post',
                    ...
                    success: function (data) {
                        if (data.success) {
                            window.location.href = "{{ route('tenant.followup-lead.edit',$followup_lead->id) }}";
                        }
                        }
            }
            );
    ...
    $('.submit_url').click(function (e) {
            e.preventDefault()
            $.ajax({
            url: '{{ route('tenant.followup-lead.update',$followup_lead->id) }}',
            type: 'post',
