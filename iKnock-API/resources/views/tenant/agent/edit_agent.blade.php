        ...
        <form method="post" enctype="multipart/form-data">
            <div class="" id="pg-form">
                ...
                <div class="col-md-8">
                    ...
                    <div class="col-sm-6 col-md-6 col-xs-12">
                <label>Startup Paid</label>
                <select class="form-control selectbox selectpicker" name="startup_paid" id="startup_paid">
                    <option value="0">
                        NO
                    </option>
                    <option value="1">
            ...
            <div class="col-sm-6 col-md-6 col-xs-12">
                <label>Startup Reimbursed</label>
                <select class="form-control selectbox selectpicker" name="startup_reimbursed" id="startup_reimbursed">
                    <option value="0">
                        NO
                    </option>
                    <option value="1">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('.id').val(id);
        var columns = ['name', 'email', 'date_of_join', 'mobile_no', 'image_url', 'user_status_id','user_group_id','startup_paid','startup_reimbursed'];
