        ...
        <form class="comm_form">
            <div class="col-md-2">
                <div class="form-group">
                    ...
                    <input type="text" placeholder="Start Date" autocomplete="off" id="datepicker" name="start_date" class="startDate date form-control">
                </div>
            </div>
            <!-- Col End -->
            ...
            <div class="col-md-2">
                <div class="form-group">
                    ...
                    <input type="text" id="datepicker2" placeholder="End Date"  autocomplete="off" name="end_date" class="endDate date form-control">
                </div>
            </div>
            <!-- Col End -->
