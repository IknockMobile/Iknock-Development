...
<div class="right_col" role="main">
        ...
        <div class="col-md-8">
            <div class="dropdown">
                <button class="btn  dropdown-toggle add-bt" type="button" data-toggle="dropdown" style="background: transparent;">
                    <span class="cust-head">Current Active Lead Status Summary</span>
            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="row" id="content-heading">
                            <div class="col-md-10">
                                <h5>Bar Chart Current Active Lead Status Summary</h5>
                            </div>
            ...
            <div class="col-md-6">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="row" id="content-heading">
                            <div class="col-md-10">
                                <h5>Pie Chart Current Active Lead Status Summary</h5>
                            </div>
                            <div class="col-md-2 text-right">
                    ...
                    <div class="panel-body">
                        <div id="container3" style="width:auto; height: 700px; margin: 0 auto"></div>
                    </div>
                </div>           
            </div>    
        </div>  
    ...
    <div class="row" id="pg-content">
        <div class="col-md-12">
            <div class="">
                <div class="panel-heading">
                    <h5>Current Active Lead Status Summary</h5>
                </div>
...
<script>
    $(document).ready(function () {
        ...
        loadChart3('GET', base_url + "/tenant/user/lead/status/report/current/pie", {}, {});
        $(document).on('click', '.save', function (e) {
            ...
            loadChart3('GET', base_url + "/tenant/user/lead/status/report/current/pie", data, headers = {});
        })
    ...
    $(document).ready(function () {
        function ColChart(user_names, status, types) {
            ...
            var chart = new CanvasJS.Chart("chartContainer", {
                ...
                width: tatol_width,
                title: {
                    text: "Lead Status Report By Active Lead",
                    fontSize: 2,
                },
                axisY: {
        ...
        ajaxRequest('GET', base_url + "/tenant/lead/status/user/report/current/new", data);
        ...
        $(document).on('click', '#export-btn', function () {
            ...
            var url = "{{URL::to('/tenant/lead/status/user/report/current/new?')}}" + qString;
