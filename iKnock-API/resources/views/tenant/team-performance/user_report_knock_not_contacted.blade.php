...
<div class="right_col" role="main">
        ...
        <div class="col-md-8">
            <div class="dropdown">
                <button class="btn  dropdown-toggle add-bt" type="button" data-toggle="dropdown" style="background: transparent;">
                    <span class="cust-head">Not Contacted Knocks Statistics Report</span>
            ...
            <div class="col-md-6">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="row" id="content-heading">
                            <div class="col-md-10">
                                <h5>Pie Chart Knocks Statistics Report</h5>
                            </div>
        ...
        <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="row" id="content-heading">
                            <div class="col-md-10">
                                <h5>Bar Chart *Not Contacted Knocks Statistics Report</h5>
                            </div>
                            <div class="col-md-2 text-right">
    ...
    <div class="row" id="pg-content">
        <div class="col-md-12">
            <div class="">
                <div class="panel-heading">
                    <h5>*Not Contacted Knocks Statistics Report</h5>
                </div>
...
<script>
    $(document).ready(function () {
        ...
        loadChart3('GET', base_url + "/tenant/user/lead/status/report/knock/pie", {}, {});
        $(document).on('click', '.save', function (e) {
            ...
            loadChart3('GET', base_url + "/tenant/user/lead/status/report/knock/pie", data, headers = {});
        })
...
<script type="text/javascript">
    $(document).ready(function () {
                ...
                if (res.code == 200) {
                    ...
                    if (month_status.length > 0) {
                        ...
                        for (var i = 0; i < month_status.length; i++) {
                            if(month_status[i].name == '*Not Contacted'){
                                tbody1 += '<tr>';
                                tbody1 += '<td>' + index + '</td>';
        ...
        ajaxRequest('GET', base_url + "/tenant/lead/status/user/report/knock/not/contacted", data);
        });
        ...
        $(document).on('click', '#export-btn', function () {
            ...
            var url = "{{URL::to('/tenant/lead/status/user/report/knock/not/contacted?')}}" + qString;
