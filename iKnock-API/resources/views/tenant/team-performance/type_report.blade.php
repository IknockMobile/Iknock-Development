        ...
        <div class="col-md-8">
            <div class="dropdown">
                <button class="btn  dropdown-toggle add-bt" type="button" data-toggle="dropdown" style="background: transparent;">
                    <span class="cust-head">Lead Type Report</span>
            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="row" id="content-heading">
                            <div class="col-md-10">
                                <h5>Bar Chart Lead type report</h5>
                            </div>
            ...
            <div class="col-md-6">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="row" id="content-heading">
                            <div class="col-md-10">
                                <h5>Pie Chart Lead type report</h5>
                            </div>
                            <div class="col-md-2 text-right">
...
<script>
    $(document).ready(function () {
        ...
        loadChart3('GET', base_url + "/tenant/user/lead/types/report", {}, {});
        $(document).on('click', '.save', function (e) {
            ...
            var data = {target_user_id: user_id, type_id: type_id, type: type, time_slot: time_slot, start_date: start_date, end_date: end_date};
            ajaxCall('GET', base_url + "/tenant/user/lead/types/report", data).then(function (res) {
                var knock_sum = '';
                var appointment_sum = '';
            ...
            loadChart3('GET', base_url + "/tenant/user/lead/types/report", data, headers = {});
        })
...
<script type="text/javascript">
    $(document).ready(function () {
        function ColChart(user_names, status, types) {
            ...
            Highcharts.chart('container', {
                ...
                xAxis: {
                    ...
                    title: {
                        text: 'Bar Chart Lead type report',
                    },
                },
                yAxis: {
                    title: {
        ...
        ajaxRequest('GET', base_url + "/tenant/lead/type/user/report", data);
        $('.save').click(function (e) {
            ...
            var data = {target_user_id: user_id, type_id: type_id, type: type, start_date: start_date, end_date: end_date, time_slot: time_slot,datetype:datetype};
            ajaxRequest('GET', base_url + "/tenant/lead/type/user/report", data);
        })
        $(document).on('click', '#export-btn', function () {
            ...
            var type = $('.value').val();
            var datetype = $('.datetype').val();
            var data = {target_user_id: user_id, type_id: type_id, type: type, start_date: start_date, end_date: end_date, export: true,datetype:datetype};
            console.log('data', data);
            var qString = $.param(data);
            var url = "{{URL::to('tenant/lead/type/user/report?')}}" + qString;
