...
<div class="right_col" role="main">
        ...
        <div class="col-md-8">
            <div class="dropdown">
                <button class="btn  dropdown-toggle add-bt" type="button" data-toggle="dropdown" style="background: transparent;">
                    <span class="cust-head">Lead Status Report By Historical Knock</span>
            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="row" id="content-heading">
                            <div class="col-md-10">
                                <h5>Bar Chart Lead Status Report By Historical Knock</h5>
                            </div>
            ...
            <div class="col-md-6">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="row" id="content-heading">
                            <div class="col-md-10">
                                <h5>Pie Chart Lead Status Report By Historical Knock</h5>
                            </div>
                            <div class="col-md-2 text-right">
    ...
    <div class="row" id="pg-content">
        <div class="col-md-12">
            <div class="">
                <div class="panel-heading">
                    <h5>Lead Status Report By Historical Knock</h5>
                </div>
...
<script>
    $(document).ready(function () {
        ...
        loadChart3('GET', base_url + "/tenant/user/lead/status/report/pie", {}, {});
        $(document).on('click', '.save', function (e) {
            ...
            loadChart3('GET', base_url + "/tenant/user/lead/status/report/pie", data, headers = {});
        })
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        ajaxRequest('GET', base_url + "/tenant/lead/status/user/report/new", data);
        });
        ...
        $(document).on('click', '#export-btn', function () {
            ...
            var url = "{{URL::to('/tenant/lead/status/user/report/new?')}}" + qString;
