...
<div class="right_col" role="main">
        ...
        <div class="col-md-8">
            <div class="dropdown">
                <button class="btn  dropdown-toggle add-bt" type="button" data-toggle="dropdown" style="background: transparent;">
                    <span class="cust-head">Knocks Statistics Report</span>
        ...
        <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="row" id="content-heading">
                            <div class="col-md-10">
                                <h5>Bar Chart Knocks Statistics Report</h5>
                            </div>
                            <div class="col-md-2 text-right">
    ...
    <div class="row" id="pg-content">
        <div class="col-md-12">
            <div class="">
                <div class="panel-heading">
                    <h5>Knocks Statistics Report</h5>
                </div>
...
<script type="text/javascript">
    $(document).ready(function () {
                ...
                if (res.code == 200) {
                    ...
                    if (month_status.length > 0) {
                        ...
                        for (var i = 0; i < month_status.length; i++) {
                            if(month_status[i].name == 'Total Leads'){
                                tbody1 += '<tr>';
                                tbody1 += '<td>' + index + '</td>';
        ...
        ajaxRequest('GET', base_url + "/tenant/lead/status/user/report/knock", data);
        });
        ...
        $(document).on('click', '#export-btn', function () {
            ...
            var url = "{{URL::to('/tenant/lead/status/user/report/knock?')}}" + qString;
