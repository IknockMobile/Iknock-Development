...
<div class="right_col" role="main">
        ...
        <div class="col-md-8">
            <div class="dropdown">
                <button class="btn  dropdown-toggle add-bt" type="button" data-toggle="dropdown" style="background: transparent;">
                    <span class="cust-head">Dashboard Knocks Statistics Report</span>
    ...
    <div class="row" id="pg-content">
        <div class="col-md-12">
            <div class="">
                <div class="panel-heading">
                    <h5>Dashboard Knocks Statistics Report</h5>
                </div>
                <div id="message">
    ...
    $(document).ready(function () {
        ...
        function chatCall(columns = {}){
            ...
            ajaxCall('GET', base_url + "/tenant/user/lead/status/report",columns).then(function (res) {
                $('.purchase-box').html('<h1>'+res.data.result_main_purchased+'</h1><h4 class="mt-4">1 Purchase for every '+res.data.result_main_purchased_by_count+' knocks</h4><h4>'+res.data.result_main_purchased_count+' Total Purchases form '+res.data.total_knocks_count+' knocks</h4>');
                $('.contract-box').html('<h1>'+res.data.result_main_contract+'</h1><h4 class="mt-4">1 Contract for every '+res.data.result_main_contract_by_count+' knocks</h4><h4>'+res.data.result_main_contract_count+' Total Contract form '+res.data.total_knocks_count+' knocks</h4>');
            });
        }
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $( window ).load(function() {
            ajaxRequest('GET', base_url + "/tenant/lead/status/user/report/dashboard_knocks_statistics", data);
        });
        ...
        $(document).on('click', '#export-btn', function () {
            ...
            var url = "{{URL::to('/tenant/lead/status/user/report/dashboard_knocks_statistics?')}}" + qString;
