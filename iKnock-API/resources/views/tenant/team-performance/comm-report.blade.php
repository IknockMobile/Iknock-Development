...
<div class="right_col" role="main">
    <div class="row" id="content-heading">
        ...
        <div class="col-md-9">
            <form class="comm_form">
                ...
                <div class="col-md-2">
                    <button type="button" class="b1" id="export-detail-btn">Export Detail</button>
    ...
    <table class="table table-striped jambo_table" id="scroll" id="">
        ...
        <tbody class="team_comm team_status"></tbody>
        <tfoot class="tfoot">
        <tr>
            <td><b>Total</b></td>
            <td></td>
    ...
    $(document).ready(function () 
    {
        ...
        ajaxCall('GET', base_url + "/tenant/user/lead/status/report").then(function (res) {
            ...
            $.each(res.data.result, function(index, val) {
                ...
                userCommission.push(val.commission_count);
            });

            // userCommission = [{'name':'Commission',data:userCommission}]; 

            var commission_new_count = '';
                commission_new_count += res.data.commission_count;
                console.log(commission_new_count);
        ...
        $(document).on('click', '#export-detail-btn', function () {
            //$(this).data('export',true);
            ...
            console.log('data', data);
            var qString = $.param(data);
            var url = "{{URL::to('tenant/commission/event/export?')}}" + qString;
            document.location.href = url;
