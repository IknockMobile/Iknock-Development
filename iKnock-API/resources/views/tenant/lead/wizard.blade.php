                                ...
                                <div class="panel-body field_head">
                                    <div class="form-group">
                                        ...
                                        <div class="lead_name_ctn">
                                            <select class="form-group form-control select lead_name selectinputvalue field_head change_fields selectpicker" data-value="lead_name" multiple="multiple" data-name="lead_name" data-max-options="4"  name="lead_name[]" >
                                    ...
                                    <div class="form-group">
                                        <label>Address</label>
                                        <div class="lead_name_ctn">
                                            <select class="form-group form-control select field_head selectinputvalue change_fields selectpicker" data-name="address" data-value="address" name="address" >
                                                <option value=""> -- Select Options -- </option>
                                            </select>
                                        </div></div>
                                    <div class="form-group">
                                        <label>City</label>
                                        <div class="lead_name_ctn">
                                            <select class="form-group form-control select field_head selectinputvalue change_fields selectpicker" data-name="city" data-value="city" name="city" >
                                                <option value=""> -- Select Options -- </option>
                                            </select>
                                        </div> </div>
                                    <div class="form-group">
                                        <label>County</label>
                                        <div class="lead_name_ctn">
                                            <select class="form-group form-control select field_head selectinputvalue change_fields selectpicker" data-name="county" data-value="county" name="county" >
                                                <option value=""> -- Select Options -- </option>
                                            </select>
                                        </div> </div>
                                    <div class="form-group">
                                        <label>State</label>
                                        <div class="lead_name_ctn">
                                            <select class="form-group form-control select custom_fields selectinputvalue field_head change_fields selectpicker" data-name="state" data-value="state" name="state" > 
                                                <option value=""> -- Select Options -- </option>
                                            </select>
                                        </div> 
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="lead_name_ctn">
                                            <select class="form-group form-control select field_head selectinputvalue change_fields selectpicker" data-name="zip_code" data-value="zip_code" name="zip_code" >
                                                <option value=""> -- Select Options -- </option>
                                            </select>
                                        </div>  
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="lead_name_ctn">
                                            <select class="form-group form-control select field_head selectinputvalue change_fields selectpicker" data-name="admin_notes" data-value="admin_notes" name="admin_notes" >
                                                <option value=""> -- Select Options -- </option>
                                            </select>
                                        </div>  
                                    </div>
                                    <div class="form-group">
                                        <label>Auction</label>
                                        <div class="lead_name_ctn">
                                            <select class="form-group form-control select custom_fields selectinputvalue field_head change_fields selectpicker" data-name="auction" data-value="auction" name="auction" > 
                                                <option value=""> -- Select Options -- </option>
                                            </select>
                                        </div> 
                                    </div>
                                     <div class="form-group">
                                        ...
                                        <div class="lead_name_ctn">
                                            <select class="form-group form-control select custom_fields selectinputvalue field_head change_fields selectpicker" data-name="lead_value" data-value="lead_value" name="lead_value"> 
                                                <option value=""> -- Select Options -- </option>
                                            </select>
                                        </div> 
                                    </div>
                                      <div class="form-group">
                                        ...
                                        <div class="lead_name_ctn">
                                            <select class="form-group form-control select custom_fields selectinputvalue field_head change_fields selectpicker" data-name="original_loan" data-value="original_loan" name="original_loan"> 
                                                <option value=""> -- Select Options -- </option>
                                            </select>
                                        </div> 
                                    </div>
                                     <div class="form-group">
                                        ...
                                        <div class="lead_name_ctn">
                                            <select class="form-group form-control select custom_fields selectinputvalue field_head change_fields selectpicker" data-name="loan_date" data-value="loan_date" name="loan_date" > 
                                                <option value=""> -- Select Options -- </option>
                                            </select>
                                        </div> 
                                    </div>
                                     <div class="form-group">
                                        <label>Sq Ft</label>
                                        <div class="lead_name_ctn">
                                            <select class="form-group form-control select custom_fields selectinputvalue field_head change_fields selectpicker" data-name="sq_ft" data-value="sq_ft" name="sq_ft" > 
                                                <option value=""> -- Select Options -- </option>
                                            </select>
                                        </div> 
                                    </div>
                                     <div class="form-group">
                                        <label>Yr Blt</label>
                                        <div class="lead_name_ctn">
                                            <select class="form-group form-control select custom_fields selectinputvalue field_head change_fields selectpicker" data-name="yr_blt" data-value="yr_blt" name="yr_blt" > 
                                                <option value=""> -- Select Options -- </option>
                                            </select>
                                        </div> 
                                    </div>
                                     <div class="form-group">
                                        <label>EQ</label>
                                        <div class="lead_name_ctn">
                                            <select class="form-group form-control select custom_fields selectinputvalue field_head change_fields selectpicker" data-name="eq" data-value="eq" name="eq" > 
                                                <option value=""> -- Select Options -- </option>
                                            </select>
                                        </div> 
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="lead_name_ctn">
                                            <select class="form-group form-control select custom_fields selectinputvalue field_head change_fields selectpicker" data-name="mortgagee" data-value="mortgagee" name="mortgagee" > 
                                                <option value=""> -- Select Options -- </option>
                                            </select>
                                        </div> 
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="lead_name_ctn">
                                            <select class="form-group form-control select custom_fields selectinputvalue field_head change_fields selectpicker" data-name="loan_type" data-value="loan_type" name="loan_type" > 
                                                <option value=""> -- Select Options -- </option>
                                            </select>
                                        </div> 
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="lead_name_ctn">
                                            <select class="form-group form-control select custom_fields selectinputvalue field_head change_fields selectpicker" data-name="loan_mod" data-value="loan_mod" name="loan_mod" > 
                                                <option value=""> -- Select Options -- </option>
                                            </select>
                                        </div> 
                                    </div>
                                    <div class="form-group">
                                        <label>Trustee</label>
                                        <div class="lead_name_ctn">
                                            <select class="form-group form-control select custom_fields selectinputvalue field_head change_fields selectpicker" data-name="trustee" data-value="trustee" name="trustee" > 
                                                <option value=""> -- Select Options -- </option>
                                            </select>
                                        </div> 
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="lead_name_ctn">
                                            <select class="form-group form-control select custom_fields selectinputvalue field_head change_fields selectpicker" data-name="owner_address" data-value="owner_address" name="owner_address" > 
                                                <option value=""> -- Select Options -- </option>
                                            </select>
                                        </div> 
                                    </div>
                                    <div class="form-group">
                                        <label>Source</label>
                                        <div class="lead_name_ctn">
                                            <select class="form-group form-control select custom_fields selectinputvalue field_head change_fields selectpicker" data-name="source" data-value="source" name="source" > 
                                                <option value=""> -- Select Options -- </option>
                                            </select>
                                        </div> 
                                    </div>
                                    ...
                                    <div class="row" style="margin:0px">
                                        ...
                                        <div class="col-md-12 show-buttons" style="display:none;">
                                            <button type="button" class="btn b2 add_field addnewField" data-toggle="modal"
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div id="query_form"></div>
                                                        ...
                                                        <select class="query-box form-control"></select>
                                                    </div>
                                                </div>
...
<script>
    ...
    function getTemplateFields(save = false) {
        ...
        console.log($('#frm_step-2').attr('action'));
        $.ajax(
            {
                type: "POST",
                ...
                success: function (res) {
                    ...
                    $('.select-template').removeAttr('disabled');
                    ...
                    if(res.data.fixed_fields != undefined){
                        $.each(res.data.fixed_fields, function(index, val) {
                            $("select[data-name=" + val.field + "]").selectpicker('val',val.index);
                        });
                    }
    ...
    $(document).ready(function () {
        ...
        $('.save_field').on('click', function () {
            var input_label = $('.query-box option:selected').val();
            ...
            if(input_label != ''){
                ...
                alert('Please Select Input Label Title');
            }
...
$(document).ready(function() {
    var id = $("[name='template_id']").val();

    $('.addnewField').click(function (e) {
        e.preventDefault();
        var id = $('.select-template option:selected').val();

        $('.query-box').html(' ');

        $.ajax({
            url: '/tenant/get/field/list',
            type: 'post',
            ...
            success: function (data) {
                ...
                $('.query-box').append('<option value=" ">Select Input Label Title</option>');

                $.each(data.success, function(index, val) {
                     var quryData = val.query;

                     if(quryData !== 'Lead Type' && quryData !== 'Lead Status' && quryData !== 'Homeowner Name' &&  quryData !== 'Zip'){
                         $('.query-box').append('<option value="'+quryData+'">'+quryData+'</option>');
                     }
                });
            }
        });
