...
<div class="right_col" role="main">
                    ...
                    <div class="row nomargin">
                        ...
                        <div class="row nomargin">
                                ...
                                <div class="col-sm-6 col-md-6 col-xs-12">
                                    <div class="form-group">
                                        <label>Auction</label>
                                        <input type="text" value="" name="auction"  class="input" >
                                    </div>
                                </div>
                                <div class="col-sm-6 col-md-6 col-xs-12">
                                    <div class="form-group">
                                        <label>Original Loan</label>
                                        <input type="text" value="" name="original_loan"  class="input" >
                                    </div>
                                </div>
                                <div class="col-sm-6 col-md-6 col-xs-12">
                                    <div class="form-group">
                                        <label>Loan Date</label>
                                        <input type="text" value="" name="loan_date"  class="input" >
                                    </div>
                                </div>
                                <div class="col-sm-6 col-md-6 col-xs-12">
                                    <div class="form-group">
                                        <label>Sq Ft</label>
                                        <input type="text" value="" name="sq_ft"  class="input" >
                                    </div>
                                </div>
                                <div class="col-sm-6 col-md-6 col-xs-12">
                                    <div class="form-group">
                                        <label>Yr Blt</label>
                                        <input type="text" value="" name="yr_blt"  class="input" >
                                    </div>
                                </div>
                                <div class="col-sm-6 col-md-6 col-xs-12">
                                    <div class="form-group">
                                        <label>Lead Value</label>
                                        <input type="text" value="" name="lead_value"  class="input" >
                                    </div>
                                </div>
                                <div class="col-sm-6 col-md-6 col-xs-12">
                                    <div class="form-group">
                                        <label>Eq</label>
                                        <input type="text" value="" name="eq"  class="input" >
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6 col-md-6 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="" name="mortgagee"  class="input" >
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6 col-md-6 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="" name="loan_type"  class="input" >
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6 col-md-6 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="" name="loan_mod"  class="input" >
                                    </div>
                                </div>
 ...
 --}}
                                <div class="col-sm-6 col-md-6 col-xs-12">
                                    <div class="form-group">
                                        <label>Trustee</label>
                                        <input type="text" value="" name="trustee"  class="input" >
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6 col-md-6 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="" name="owner_address"  class="input" >
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6 col-md-6 col-xs-12">
                                    <div class="form-group">
                                        <label>Source</label>
                                        <input type="text" value="" name="source"  class="input" >
                                    </div>
                                </div>
